          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600 mt-1">Consistent Capital Preservation</div>
                ...
                <div className="text-3xl font-bold text-gold-400 mb-2">76%</div>
                <div className="text-gray-700 font-medium">Win Rate</div>
                <div className="text-sm text-gray-600 mt-1">Profitable Trades</div>
              <div className="text-sm text-gray-600 mt-1">Winners vs Losers</div>
                ...
                <div className="text-sm text-gray-600 mt-1">Risk-Adjusted Returns</div>
