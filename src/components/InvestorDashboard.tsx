          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-8 mb-4 md:mb-8">
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Account Funding</h3>
                <p className="text-gray-600">Add capital to your managed account</p>
              </div>
              
              <button
                onClick={() => setShowFundingModal(true)}
                className="w-full bg-navy-600 hover:bg-navy-700 text-white px-6 py-4 rounded-lg font-semibold transition-colors text-lg flex items-center justify-center"
              >
