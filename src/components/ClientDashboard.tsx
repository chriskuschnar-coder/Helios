...
export function ClientDashboard({ user, onLogout }: ClientDashboardProps) {
  ...
  const holdings = [
    { name: 'Alpha Fund', allocation: 65, value: 1592500, return: 14.2, risk: 'Medium' },
    { name: 'Market Neutral Fund', allocation: 25, value: 612500, return: 8.7, risk: 'Low' },
    { name: 'Momentum Portfolio', allocation: 10, value: 245000, return: 18.9, risk: 'High' }
  ]
