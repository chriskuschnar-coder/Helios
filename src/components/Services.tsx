      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 bg-white border border-gray-200 rounded-2xl p-8 lg:p-12">
          <h3 className="font-serif text-2xl font-bold text-navy-900 mb-8 text-center">
            Investment Strategies Designed for Success
          </h3>
          ...
          <p className="text-center text-gray-600 mt-8">
            Professional investment strategies designed for qualified investors 
            seeking superior risk-adjusted returns through disciplined portfolio management 
            and proven risk controls that protect and grow your capital.
          </p>
        </div>
      </div>
    </section>
