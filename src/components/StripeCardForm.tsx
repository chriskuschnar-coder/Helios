...
export function StripeCardForm({ amount, onSuccess, onError, className = '' }: StripeCardFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('💳 Processing embedded card payment for amount:', amount)
      ...
      if (sessionError || !session) {
        console.error('❌ No valid session for payment processing')
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
          ...
          <p className="text-sm text-blue-700">
            Your payment information is encrypted and secure. Redirects to Stripe Checkout.
          </p>
        </div>
